public class Driver 
{
	public static void main(String[] args)
	{
		...
		System.out.println(Driver.removeDigits("he11o"));
	}
	...
	{
		String answer = s.replaceAll("[AaEeIiOoUuYy]", "");
		return answer;
	}
	...
	{
		String answer = s.replaceAll("[QWRTPSDFGHJKLZXCVBNMqwrtpsdfghjklzxcvbnm]", "");
		return answer;
	}
	...
	{
		String answer = s.replaceAll("[1234567890]", "");
		return answer;
	}
