...
public class Driver 
{
	...
	public static void main(String[] args)
	{
		...
		char turnOrder = 'X';
		Driver.makeMove(row, column, turnOrder);
		turnOrder = Driver.playGame(turnOrder);
		Driver.displayBoard();
		int i = 2;
		while(i == 2)
		{
			System.out.print("Please enter a row:");
			row = Driver.getIntFromUser();
			System.out.print("Please enter a column:");
			column = Driver.getIntFromUser();
			Driver.makeMove(row, column, turnOrder);
			turnOrder = Driver.playGame(turnOrder);
			Driver.displayBoard();
		}
	...
	static char playGame(char turnOrder)
	{
		if(turnOrder == 'X')
		{
			turnOrder = 'O';
